<%!
    ...
    public String Hundreds(int wholeNumber, int decimalNumber, String converted){
        ...
        //Convert the number:
        switch(currentChar){
            case 9:     converted = converted + singles[9] + " " + bigNums[0] + " and ";
                        break;
            case 8:     converted = converted + singles[8] + " " + bigNums[0] + " and ";
                        break;
            case 7:     converted = converted + singles[7] + " " + bigNums[0] + " and ";
                        break;
            case 6:     converted = converted + singles[6] + " " + bigNums[0] + " and ";
                        break;
            case 5:     converted = converted + singles[5] + " " + bigNums[0] + " and ";
                        break;
            case 4:     converted = converted + singles[4] + " " + bigNums[0] + " and ";
                        break;
            case 3:     converted = converted + singles[3] + " " + bigNums[0] + " and ";
                        break;
            case 2:     converted = converted + singles[2] + " " + bigNums[0] + " and ";
                        break;
            case 1:     converted = converted + singles[1] + " " + bigNums[0] + " and ";
                        break;
            default:    converted = "An Unknown Error Occured.";
                        break;
        }
